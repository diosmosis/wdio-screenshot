    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return _regenerator2.default.awrap(browser.executeScript(_getScreenDimensions2.default));
        ...
        case 13:
          ...
          _context.next = 17;
          return _regenerator2.default.awrap(browser.executeScript(_pageHeight2.default, screenDimension.getDocumentHeight() + 'px'));
        ...
        case 18:
          ...
          _context.next = 22;
          return _regenerator2.default.awrap(browser.executeScript(_virtualScroll2.default, x, y, false));

        case 22:
          _context.next = 24;
          return _regenerator2.default.awrap(browser.sleep(100));

        case 24:
          filePath = _path2.default.join(dir, indexY + '-' + indexX + '.png');
          _context.next = 27;
          return _regenerator2.default.awrap(browser.takeScreenshot());

        case 27:
          base64Screenshot = _context.sent;
        ...
        case 40:
          ...
          _context.next = 43;
          return _regenerator2.default.awrap(browser.executeScript(_pageHeight2.default, ''));

        case 43:

          log('revert scroll to x: %s, y: %s', 0, 0);
          _context.next = 46;
          return _regenerator2.default.awrap(browser.executeScript(_virtualScroll2.default, 0, 0, true));
