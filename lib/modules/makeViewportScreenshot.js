...
exports.default = function makeViewportScreenshot(browser) {
  ...
  var _ref, _ref2, startX, startY, screenDimensions, screenDimension, base64Image;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return _regenerator2.default.awrap(browser.executeScript(_getScrollPosition2.default));
        ...
        case 18:
          _context.next = 20;
          return _regenerator2.default.awrap(browser.executeScript(_scroll2.default, startX, startY));
