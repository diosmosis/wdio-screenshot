    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return _regenerator2.default.awrap((0, _selectorExecute2.default)(browser, options.hide, _modifyElements2.default, 'opacity', ''));
        ...
        case 4:
          ...
          _context.next = 8;
          return _regenerator2.default.awrap((0, _selectorExecute2.default)(browser, options.remove, _modifyElements2.default, 'display', ''));
        ...
        case 8:
          ...
          _context.next = 11;
          return _regenerator2.default.awrap(browser.executeScript(_scrollbars2.default, true));
